...
// Three.js/WebGL must be client-only — dynamic import with ssr disabled
// avoids "window is not defined" during the Next.js server build.
const BuildingScene = dynamic(
  () => import('./building-scene').then((m) => m.BuildingScene),
  { ssr: false }
)
