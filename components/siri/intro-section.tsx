        ...
        <div>
          ...
          <Reveal delay={0.1}>
            <p className="mt-8 max-w-md text-pretty leading-relaxed text-muted-foreground">
              Siri Construction delivers thoughtfully planned residential and civil
              construction projects with a focus on quality, reliability and lasting
              value.
            </p>
          </Reveal>
          <Reveal delay={0.15}>
