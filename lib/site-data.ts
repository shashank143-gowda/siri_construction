...
// Placeholders — replace with real, verified company numbers.
export const stats = [
  { value: 'XX', suffix: '+', label: 'Projects Completed' },
  { value: 'XX', suffix: '+', label: 'Years Experience' },
  { value: 'XX', suffix: '+', label: 'Happy Clients' },
